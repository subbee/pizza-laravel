...
! function() {
    ...
    window.tram = function(t) {
        ...
        if (C.transition) {
            var I = C.timing.dom;
            if (M.style[I] = d["ease-in-back"][0], !M.style[I])
        ...
        var $ = e.frame = function() {
            ...
            D = f(function(e) {
                ...
                e.init = function(e) {
                    ...
                    C.backface && U.hideBackface && Z(this.el, C.backface.css, "hidden")
            ...
            X = f(function(e) {
                ...
                function a() {
                    ...
                    if (i)
                        for ($(a), e = S(), t = i; t--;)(n = h[t]) && n.render(e)
                }
    ...
    var e = {},
        ...
        r = t(function(t) {
            ...
            function l() {
                E && (E.reject(), m.off("load", E.resolve)), E = new v.Deferred, m.on("load", E.resolve)
            }
            var f = {},
                d = {},
                h = [],
            ...
            y.config.hideBackface = !1, y.config.keepInherited = !0, f.define = function(t, e, i) {
                ...
                var e = window.__wf_design,
                    n = void 0 !== e;
                return t ? "design" === t ? n && e : "preview" === t ? n && !e : "slug" === t ? n && window.__wf_slug : "editor" === t ? window.sbwEditor : "test" === t ? window.__wf_test : "frame" === t ? window !== window.top : void 0 : n
            };
            ...
            f.env.safari = /safari/.test(_) && !z && !L;
            var M;
            ...
            var A = "resize.sbw orientationchange.sbw load.sbw";
            f.resize = s(m, A), f.scroll = s(m, "scroll.sbw resize.sbw orientationchange.sbw load.sbw"), f.redraw = s(), f.location = function(t) {
                window.location = t
            ...
            f.load = function(t) {
                ...
                t = t || {}, k = !0, m.triggerHandler("__wf_destroy"), null != t.domready && (x = t.domready), b.each(d, o), f.resize.off(), f.scroll.off(), f.redraw.off(), h = [], p = [], "pending" === E.state() && l()
            }, v(f.ready), l(), t.exports = window.sbw = f
        }),
        ...
        a = (t(function(t) {
            ...
            e.define("brand", t.exports = function(t) {
                function n() {
                    var e = t('<a class="w-sbw-badge"></a>').attr("href", "https://sbw.com?utm_campaign=brandjs"),
                        n = t("<img>").attr("src", "https://d1otoma47x30pg.cloudfront.net/img/sbw-badge-icon.60efbf6ec9.svg").css({
                            marginRight: "8px",
                            width: "16px"
                        }),
                        i = t("<img>").attr("src", "https://d1otoma47x30pg.cloudfront.net/img/sbw-badge-text.6faa6a38cd.svg");
                ...
                return o.ready = function() {
                    ...
                    /\.sbw\.io$/i.test(e) && c.hostname !== e && (t = !0), t && !l && (r = r || n(), i(), setTimeout(i, 500))
                }, o
            })
        }), t(function(t) {
            /*!
             * jQuery-ajaxTransport-XDomainRequest - v1.0.3
             * 2014-12-16 sbw - Removed UMD wrapper
            ...
            e.define("forms", t.exports = function(t, n) {
                ...
                function r(e, n) {
                    ...
                    r.handler = null, r.redirect = i.attr("data-redirect"), z.test(s) ? r.handler = f : s || (v ? r.handler = l : L())
                }
                ...
                function l(n) {
                    ...
                    if (o) return T(o);
                    if (s(n), v) {
                        var c = "https://sbw.com/api/v1/form/" + v;
                        y && c.indexOf("https://sbw.com") >= 0 && (c = c.replace("https://sbw.com", "http://formdata.sbw.com")), t.ajax({
                            url: c,
                            type: "POST",
                            data: r,
                            dataType: "json",
                ...
                var p, v, m, g = {},
                    ...
                    L = n.debounce(function() {
                        T("Error! Looks like the form has been incorrectly configured.")
                    }, 100);
    ...
    t(function(t) {
        ...
        e.define("ix", t.exports = function(t, i) {
            ...
            function o() {
                var i = t("[data-ix]");
                i.length && (i.each(u), i.each(a), L.length && (e.scroll.on(c), setTimeout(c, 1)), M.length && e.load(l), A.length && setTimeout(f, E), n.init(), e.redraw.up())
            }
            ...
            return g.init = function(t) {
                ...
                m = !0, O.each(u), e.scroll.off(c), n.async(), L = [], M = [], A = []
            }, g.ready = function() {
        ...
        n.define("lightbox", t.exports = function(t) {
            ...
            return c.ready = c.design = c.preview = function() {
                s = l && n.env("design"), f.destroy(), u = {}, (a = d.find(h)).sbwLightBox()
            }, jQuery.fn.extend({
                sbwLightBox: function() {
                    var e = this;
        ...
        e.define("navbar", t.exports = function(t, i) {
            ...
            function s(e, n) {
                ...
                r || (r = t.data(n, j, {
                    ...
                    el: i,
                    config: {}
                })), r.menu = i.find(".w-nav-menu"), r.links = r.menu.find(".w-nav-link"), r.dropdowns = r.menu.find(".w-dropdown"), r.button = i.find(".w-nav-button"), r.container = i.find(".w-container"), r.outside = m(r), r.el.off(j), r.button.off(j), r.menu.off(j), f(r), T ? (c(r), r.el.on("setting" + j, d(r))) : (l(r), r.button.on("tap" + j, p(r)), r.menu.on("click" + j, "a", v(r))), g(e, n)
            }

            function u(e, n) {
                var i = t.data(n, j);
                i && (c(i), t.removeData(n, j))
            }
            ...
            function m(e) {
                return e.outside && M.off("tap" + j, e.outside), i.debounce(function(n) {
                    if (e.open) {
            ...
            function b(t, n) {
                if (!t.open) {
                    t.open = !0, t.menu.addClass(I), t.links.addClass(q), t.button.addClass(C);
                    var i = t.config;
                    ...
                    var r = y(t),
                        ...
                        s = t.el.height(),
                        u = t.el[0];
                    if (g(0, u), $.intro(0, u), e.redraw.up(), T || M.on("tap" + j, t.outside), !n) {
            ...
            function y(t) {
                var e = t.config,
                    n = e.docHeight ? M.height() : k.height();
            ...
            function x(t, e) {
                function n() {
                    t.menu.height(""), z(t.menu).set({
                        x: 0,
                        y: 0
                    }), t.menu.removeClass(I), t.links.removeClass(q), t.overlay && t.overlay.children().length && (S.length ? t.menu.insertAfter(S) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close")
                }
                if (t.open) {
                    t.open = !1, t.button.removeClass(C);
                    var i = t.config;
                    if (("none" === i.animation || !z.support.transform || i.duration <= 0) && (e = !0), $.outro(0, t.el[0]), M.off("tap" + j, t.outside), e) return z(t.menu).stop(), void n();
            ...
            O.ready = O.design = O.preview = function() {
                T = A && e.env("design"), k = t(document.body), (_ = M.find(j)).length && (_.each(s), r(), o())
            }, O.destroy = function() {
        ...
        e.define("slider", t.exports = function(t, i) {
            function r() {
                (_ = A.find(j)).length && (_.filter(":visible").each(u), z = null, O || (o(), a()))
            }
            ...
            function u(e, n) {
                ...
                if (r || (r = t.data(n, j, {
                        ...
                        el: i,
                        config: {}
                    })), r.mask = i.children(".w-slider-mask"), r.left = i.children(".w-slider-arrow-left"), r.right = i.children(".w-slider-arrow-right"), r.nav = i.children(".w-slider-nav"), r.slides = r.mask.children(".w-slide"), r.slides.each(I.reset), z && (r.maskWidth = 0), !M.support.transform) return r.left.hide(), r.right.hide(), r.nav.hide(), void(O = !0);
                r.el.off(j), r.left.off(j), r.right.off(j), r.nav.off(j), c(r), T ? (r.el.on("setting" + j, m(r)), v(r), r.hasTimer = !1) : (r.el.on("swipe" + j, m(r)), r.left.on("tap" + j, f(r)), r.right.on("tap" + j, d(r)), r.config.autoplay && !r.hasTimer && (r.hasTimer = !0, r.timerCount = 1, p(r))), r.nav.on("tap" + j, "> div", m(r)), E || r.mask.contents().filter(function() {
            ...
            function g(e, n) {
                function i() {
                    d = t(o[e.index].els), p = e.slides.not(d), "slide" !== v && (f.visibility = "hidden"), M(p).set(f)
                }
                n = n || {};
                var r = e.config,
                    o = e.anchors;
                ...
                var c = e.offsetX || 0,
                    ...
                    b = "opacity " + g + "ms " + m,
                    y = "transform " + g + "ms " + m;
                if (T || (d.each(I.intro), p.each(I.outro)), n.immediate && !z) return M(d).set(f), void i();
                if (e.index !== e.previous) {
                    if ("cross" === v) {
                        var x = Math.round(g - g * r.crossOver),
                            k = Math.round(g - x);
                        return b = "opacity " + x + "ms " + m, M(h).set({
                            visibility: ""
                        }).add(b).start({
                            opacity: 0
                        }), void M(d).set({
                    ...
                    return "fade" === v ? (M(h).set({
                        ...
                        x: l
                    }).then(i)) : void(r.infinite && s.x ? (M(e.slides.not(h)).set({
                        visibility: "",
                        x: s.x
                    }).add(y).start({
                        x: l
                        ...
                        x: s.to
                    }), e.shifted = h) : (r.infinite && e.shifted && (M(e.shifted).set({
                        visibility: "",
                        x: c
                    }), e.shifted = null), M(e.slides).set({
                        visibility: ""
                    }).add(y).start({
                        x: l
                    })))
            ...
            function y(e) {
                ...
                r && (r = parseFloat(r) + "px");
                for (var o = 0; o < e.pages; o++) n = t(C), e.nav.hasClass("w-num") && n.text(o + 1), null != r && n.css({
                    "margin-left": r,
                    "margin-right": r
                }), i.push(n);
