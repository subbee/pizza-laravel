<x-app-layout> {{-- Ez hívja meg a fő layoutot komponensként --}}
    ...
    <div class="relative bg-gray-900 overflow-hidden"
         style="background-image: url('https://images.unsplash.com/photo-1513104890138-7c749659a591?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80'); background-size: cover; background-position: center center;">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    A Pizza Mesternél hiszünk a minőségben. Minden pizzánkat frissen, válogatott, helyi alapanyagokból készítjük.  
                    Célunk, hogy a város legjobb pizzáját szállítsuk ki neked — gyorsan és forrón.
                </p>
            </div>
        </div>
    </div>
