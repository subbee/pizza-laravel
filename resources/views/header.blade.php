    ...
    <div class="top-info-bar-container w-container">
        <div class="w-row">
            <div class="top-info-info-column-first w-col w-col-4">
                <div class="top-info-info-text"><img src="/assets/images/location.png" alt="N.Y. Pizza"><strong>123 Broadway St., New York, NY 12345</strong></div>
            </div>
            <div class="top-info-info-column-center w-col w-col-4">
                <div class="top-info-info-text"><img src="/assets/images/ph.png" alt="N.Y. Pizza"> &nbsp;<strong>(123) 456 - 7890. Free delivery over $15!</strong></div>
            </div>
...
<header class="header">
    <div class="navbar w-nav" data-animation="default" data-collapse="medium" data-doc-height="1" data-duration="500" data-no-scroll="1">
        <div class="container w-container">
            ...
            <!-- Logo section begins -->
            <a class="brand w-nav-brand" href="index.html"><img src="/assets/images/logo.png" alt="N.Y. Pizza"></a>
            <!-- Logo section ends -->
            <!-- Main navigation begins -->
            <nav class="nav-menu w-nav-menu">
                <a class="main-link w-nav-link" href="index.html">home</a>
                <a class="main-link w-nav-link" href="menu.html">menu</a>
                <a class="main-link w-nav-link" href="specials.html">specials</a>
                <a class="main-link w-nav-link" href="about.html">about</a>
                <a class="main-link w-nav-link" href="photos.html">photos</a>
